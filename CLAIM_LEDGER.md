...
| 9 | Gating-corrected ρ̂ (dominance partition) | lock **`e043307`** | `analysis/analyze_round9.py` (frozen) | **P1M/P2M PASS** 16/16 (MAE≤0.0026); **P1O/P2O INCONCLUSIVE**; **P3 FALSIFIED**; P4 PASS 16/16 (sparse σ=0 counts) | report §18, PAPER §8, `results/round9/SUMMARY.md` + `REPORTING_APPENDIX.md` |
| 10 | TopK absorption (2-atom ε\*=2q; capacity collapse) | lock **`4d62b90`** | `analysis/analyze_round10.py` (frozen) | **P1 INCONCLUSIVE** (m=2 SGD degenerate); **P2 FALSIFIED**; P3 PARTIAL; **P4 direction inverted** (was "refuted") | report §19, PAPER §10, `theory/topk_absorption.md`, `results/round10/SUMMARY.md` |
